...
async function main() {
  try {
    ...
    const id = 'K091cuBitjnfJRHNJLDG';
    const name = 'Thonglor XXX Condominium';
    const address = 'Thonglor, Bangkok Thailand';
    const about = 'Condominium Acquisition';
    const agentId = 'rHfDz2hI2NopdQJFE2pm';
    const ownerId = 'rzcjRBh4Wb4dfZDIXjcT';
    const type = 'Residential';
    const price = parseFloat(300000);
